...
- Phase Two items (SW §14 parking lot: CRM/offline conversions, LTV, self-updating playbooks, comments, competitor monitoring, fraud gating, runbooks) are **not to be built** — route temptation to `BACKLOG.md`. *(Restriction lifted by owner 2026-06-11 — see DECISIONS.md; offline conversions and self-updating playbooks are now built, the rest remain parked in BACKLOG.md.)*
